            ...
            <div className="AccountContainer">
                    {this.state.current === 0 &&(
                        ...
                        <form onSubmit={this.handlesubmit} method="post" >
                            ...
                            <div className="submitContainer" >
                                <button className="Submitbutton" style={{ "text-align": "center" }} value="Sign up" onClick={()=>this.next()}>Sign up</button><br />
                ...
                {this.state.current === 1 && (
                    <div>
                        ...
                        {!this.state.captchaState && (
                            <h2>Please enter a valid phone number , we will send a verification code . </h2>
                        )}
                        {!this.state.captchaState && (
                            <div>
                                ...
                                <div className="verifContainer">
                                    <Lottie options={verifOptions} height={50} width={50} className="card1" />
                        ...
                        {!this.state.captchaState && (
                            <div className="submitContainer">
                                <button className="Submitbutton" style={{ "text-align": "center" }} onClick={this.handlePhoneClick} disabled={!this.state.isvalid}>Add number</button><br />
                            </div>
                        ...
                        <div id="recaptcha" className={this.state.submitState ? 'val' : 'normale'}></div>
                    
                        {/* {this.state.captchaState && !this.state.submitState && (
                            <div className="submitContainer">
                                <button className="Submitbutton" style={{ "text-align": "center" }} onClick={this.handleVerif} disabled={!this.state.isvalid}>Send code</button><br />
                            </div>
                        )} */}
                        {/* -------------------------------------------------------  */}
                        ...
                        {this.state.submitState && !this.state.numberVerified && (
                            <h2>Please type the verification code sent to {this.state.phone}</h2>
                        )}
                        {this.state.submitState && !this.state.numberVerified &&(
                            <div className="inputs">
                                <i className="fa fa-phone icon"></i>
                                <input className='field ' onChange={this.handlechange} required type="tel" id="codeverif" placeholder="Provide the code we sent you" /><br />
                            </div>
                        )}

                        {this.state.submitState && !this.state.numberVerified && (
                            <div className="submitContainer">
                                <button className="Submitbutton" style={{ "text-align": "center" }} onClick={this.handleVerif} disabled={!this.state.isvalid}>Verify</button><br />
                            </div>
                        )}
                ...
                {this.state.current === 2 && (
                    <div>
                        ...
                        <div className="inputs">
                            <i className="fa fa-envelope icon"></i>
                            <input className='field ' required type="tel" id="phone" /><br />
                        </div>
                        <div className="submitContainer">
                            <input className="Submitbutton" type="button" style={{ "text-align": "center" }} value="Verify" onClick={() => this.next()}></input><br />
                        </div>
